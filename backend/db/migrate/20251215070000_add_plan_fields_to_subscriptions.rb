class AddPlanFieldsToSubscriptions < ActiveRecord::Migration[7.2]
  def change
    ...
    # Make plan_id optional (for backward compatibility with existing data)
    # Note: plan_id will be removed in a future migration
    change_column_null :subscriptions, :plan_id, true if column_exists?(:subscriptions, :plan_id)
  end
end
